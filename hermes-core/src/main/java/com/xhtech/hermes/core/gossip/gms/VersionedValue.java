...
public class VersionedValue implements Comparable<VersionedValue> {
    ...
    public final static String APP_TYPE_COMMUNICATION = "communication";
    public final static String APP_TYPE_MESSAGE = "message";
    public final static String APP_TYPE_MONITOR = "monitor";
    ...
    public boolean isCommunication() {
        return value.equals(APP_TYPE_COMMUNICATION);
    }

    public boolean isMessage() {
        return value.equals(APP_TYPE_MESSAGE);
    }

    public boolean isMonitor() {
        return value.equals(APP_TYPE_MONITOR);
    }
    ...
    public static class VersionedValueFactory {
        ...
        public VersionedValue communication() {
            return new VersionedValue(APP_TYPE_COMMUNICATION);
        }

        public VersionedValue message() {
            return new VersionedValue(APP_TYPE_MESSAGE);
        }

        public VersionedValue monitor() {
            return new VersionedValue(APP_TYPE_MONITOR);
        }
