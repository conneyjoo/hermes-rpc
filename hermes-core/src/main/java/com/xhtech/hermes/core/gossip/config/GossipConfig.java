...
public class GossipConfig {
    ...
    public GossipConfig(String listen_address, String seeds, int serverPort) {
        this.listen_address = listen_address;
        this.seeds = seeds;
        this.serverPort = serverPort;
    }

    public GossipConfig(String listen_address, String seeds, String serverHost, int serverPort, String serverId, String schoolId, String secret) {
        this.listen_address = listen_address;
        this.seeds = seeds;
