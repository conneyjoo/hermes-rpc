...
/**
 * This mesg gets sent out as a result of the receipt of a GossipDigestAckMessage. This the
...
class GossipDigestAck2Message {
    ...
    GossipDigestAck2Message(Map<ServerAddress, EndpointState> epStateMap) {
