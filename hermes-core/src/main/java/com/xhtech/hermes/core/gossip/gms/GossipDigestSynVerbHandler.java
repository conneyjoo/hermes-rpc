...
public class GossipDigestSynVerbHandler implements IVerbHandler {
    ...
    public void doVerb(Message message, String id) {
        ...
        if (!Gossiper.instance.isEnabled()) {
            if (logger_.isTraceEnabled())
                logger_.trace("Ignoring GossipDigestSynMessage because consumer is disabled");
            return;
        }
        ...
        try {
            ...
            /* If the mesg is from a different cluster throw it away. */
    ...
    */
    private void doSort(List<GossipDigest> gDigestList) {
        ...
        */
        ...
        for (GossipDigest gDigest : gDigestList) {
            ServerAddress ep = gDigest.getEndpoint();
